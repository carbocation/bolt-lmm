...
parity after BOLT sample subsetting and hardcall conversion. The Stage 2 test
also reorders and masks model samples before comparing complete association
output from the BED and PGEN streaming paths.
